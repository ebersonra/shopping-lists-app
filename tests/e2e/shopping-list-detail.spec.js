...
test.describe('Shopping List Detail Page', () => {
  ...
  test('should not show 400 Bad Request for valid UUID in get-shopping-list API', async ({ page }) => {
    const validListId = '12345678-1234-1234-1234-123456789012';
...
test.describe('Shopping List Detail - CRUD Operations', () => {
  ...
  test('should handle update operations with valid UUIDs', async ({ page }) => {
    ...
    const editButton = page.locator('button:has-text("Editar"), button:has-text("Edit"), [data-action="edit"]').first();
  ...
  test('should handle delete operations with valid UUIDs', async ({ page }) => {
    ...
    const deleteButton = page.locator('button:has-text("Excluir"), button:has-text("Delete"), [data-action="delete"]').first();
  ...
  test('should handle adding items with valid UUIDs', async ({ page }) => {
    ...
    const addButton = page.locator('button:has-text("Adicionar"), button:has-text("Add Item"), [data-action="add-item"]').first();
