...
test.describe('Navigation Flow', () => {
  ...
  test('should navigate from welcome page to shopping lists page after form submission', async ({
    page,
  }) => {
    await page.goto('/src/pages/shopping-welcome.html');
  ...
  test('should navigate from welcome page to shopping lists page when skipping', async ({
    page,
  }) => {
    await page.goto('/src/pages/shopping-welcome.html');
  ...
  test('should navigate to create shopping list page from shopping lists page', async ({
    page,
  }) => {
    // Set user data in localStorage
    await page.goto('/src/pages/shopping-welcome.html');
  ...
  test('should redirect from create shopping list page to welcome if no user data', async ({
    page,
  }) => {
