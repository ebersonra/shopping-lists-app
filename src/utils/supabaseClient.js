...
async function getUserByPhone(phone) {
  try {
    ...
    const { data, error } = await client.rpc('get_user_by_phone', { p_phone: cleanPhone });
...
async function getUserById(userId) {
  try {
    ...
    const { data, error } = await client.rpc('get_user_by_id', { p_user_id: userId });
...
async function getUserStatistics(userId) {
  try {
    ...
    const { data, error } = await client.rpc('get_user_statistics', { p_user_id: userId });
